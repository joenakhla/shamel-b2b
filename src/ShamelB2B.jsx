    ...
    <div dir={t.dir} style={{ fontFamily: t.font, background: "#FAFBFC", color: "#1a1a2e", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(255,255,255,0.95)", backdropFilter: "blur(20px)", borderBottom: "1px solid #e8ecf0", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 6, cursor: "pointer" }} onClick={() => scrollTo("hero")}>
          <span style={{ fontSize: 20, fontWeight: 800, color: "#0a1628" }}>Shamel</span>
          <span style={{ fontSize: 13, fontWeight: 500, color: "#6b7280" }}>{t.forBusiness}</span>
        </div>
...
<section style={{ background: "#f8fafc", padding: "48px 24px", direction: isRtl ? "rtl" : "ltr" }}>
  <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
    ...
    <p style={{
      ...
      {/* ===== WHATSAPP CTA ===== */}
<a
  href="https://wa.me/201044070555?text=%D8%A3%D9%87%D9%84%D8%A7%D9%8B%D8%8C%20%D8%B9%D8%A7%D9%8A%D8%B2%20%D8%A3%D8%B9%D8%B1%D9%81%20%D8%A3%D9%83%D8%AA%D8%B1%20%D8%B9%D9%86%20%D8%B4%D8%A7%D9%85%D9%84"
  target="_blank"
  rel="noopener noreferrer"
  style={{
    position: "fixed",
    bottom: chatOpen ? 24 : 90,
    right: 24,
    width: 56,
    height: 56,
    borderRadius: 28,
  ...
  title="تواصل معانا على الواتساب"
>
