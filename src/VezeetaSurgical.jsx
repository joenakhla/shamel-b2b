...
const FAQS = [
  {
    q: "الاستشارة فعلاً مجانية؟",
    a: "أيوا، الاستشارة الأولى مجانية تماماً مع أخصائي رعاية صحية. هدفنا نفهم حالتك ونساعدك تاخد القرار الصح — من غير أي ضغط أو التزام.",
  },
  {
    q: "إيه الخدمات والتخصصات المتاحة؟",
    a: "عندنا تغطية واسعة تشمل: مناظير المعدة والجهاز الهضمي، جراحات العظام، الجراحة العامة، القلب والأوعية الدموية، التجميل والجلدية، نساء وتوليد، المسالك البولية، وجراحات العيون.",
  },
  {
    q: "مين اللي بيختار الدكتور أو المستشفى؟",
    a: "إحنا بنعرض عليك كل الخيارات المناسبة لحالتك بناءً على خبرة الأطباء وتقييمات المرضى السابقين — وانت اللي بتقرر وبتختار اللي يريّحك.",
  },
  {
    q: "بتتابعوا مع المريض بعد الإجراء؟",
    a: "طبعاً. فريق فيزيتا بيفضل معاك من أول الاستشارة لحد ما تتعافى تماماً — متابعة مستمرة في كل خطوة.",
  },
  {
    q: "الأسعار واضحة من البداية؟",
    a: "١٠٠٪. بنوضحلك التكلفة الكاملة قبل ما تاخد أي قرار — بدون رسوم مخفية أو مفاجآت.",
  },
];
...
const STEPS = [
  {
    ...
    desc: "سجّل بياناتك في ثواني واحجز جلسة مع أخصائي رعاية صحية — من غير أي تكلفة أو التزام",
  },
  {
    num: "٢",
    title: "احكيلنا عن حالتك",
    desc: "فريقنا يسمعك ويفهم حالتك بالتفصيل عشان يقدر يساعدك بأفضل شكل ممكن",
  },
  {
    num: "٣",
    title: "نعرض عليك كل الخيارات المناسبة",
    desc: "نرشّحلك أفضل المتخصصين والمستشفيات اللي تناسب حالتك — وانت تختار اللي يريّحك",
  },
  {
    num: "٤",
    title: "تعمل إجراءك وترجع بالسلامة",
    desc: "نفضل معاك خطوة بخطوة — من التحضير للإجراء لحد ما تتعافى تماماً",
  },
];
...
export default function VezeetaSurgical() {
  ...
  const [formData, setFormData] = useState({ name: "", phone: "", specialty: "", notes: "" });
  ...
  const handleSearch = (q) => {
    ...
    const results = SERVICES.filter(
      (s) => s.name.includes(q) || s.sub.includes(q)
    );
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await fetch("https://formsubmit.co/ajax/youssef.medhat@vezeeta.com", {
        ...
        body: JSON.stringify({
          _subject: `طلب استشارة جراحية جديد — ${formData.specialty} — ${formData.name}`,
          الاسم: formData.name,
          "رقم الموبايل": formData.phone,
          التخصص: formData.specialty,
          ملاحظات: formData.notes || "لا يوجد",
          المصدر: "صفحة الإجراءات الطبية",
        }),
      });
    } catch (_) {}
  ...
  const btnPrimary = {
    ...
    cursor: "pointer",
    fontFamily: font,
    boxShadow: `0 4px 16px rgba(89,154,215,0.35)`,
    transition: "all 0.2s",
  };
  ...
  return (
    <div dir="rtl" style={{ fontFamily: font, background: C.white, color: C.charcoal, overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{
            ...
            <span style={{ color: "#fff", fontWeight: 900, fontSize: 20, lineHeight: 1 }}>V</span>
      ...
      <section style={{
        ...
        <div style={{ position: "absolute", bottom: -60, right: -60, width: 300, height: 300, borderRadius: "50%", background: `radial-gradient(circle, rgba(255,111,97,0.06), transparent)`, pointerEvents: "none" }} />

        <div style={{ maxWidth: 860, margin: "0 auto", textAlign: "center" }} className="fade-up">
          {/* Chip */}
          <div style={{
            display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 24,
            background: C.accentLight, borderRadius: 100, padding: "6px 16px",
          }}>
          ...
          <h1 className="hero-title" style={{ fontSize: 48, fontWeight: 900, lineHeight: 1.3, marginBottom: 20 }}>
            <span style={{ color: C.charcoal }}>من الاستشارة للتعافي</span>
            <br />
          ...
          <div ref={searchRef} style={{ position: "relative", maxWidth: 600, margin: "0 auto 24px" }}>
            <div style={{
              ...
              boxShadow: `0 4px 24px rgba(89,154,215,0.15)`,
              border: `1.5px solid ${C.border}`,
              background: C.white,
            }}>
              <input
                type="text"
                placeholder="ابحث عن التخصص أو الإجراء اللي تحتاجه..."
                value={searchQuery}
                onChange={(e) => handleSearch(e.target.value)}
                onFocus={() => searchQuery && setShowDropdown(true)}
                style={{
                  flex: 1, padding: "16px 20px", border: "none", outline: "none",
                  fontSize: 16, fontFamily: font, direction: "rtl", background: "transparent",
                  color: C.charcoal,
                }}
              />
              <button
                onClick={() => {
                  if (searchResults.length > 0) selectService(searchResults[0]);
                }}
                style={{
                  background: `linear-gradient(135deg, ${C.primary}, ${C.primaryDark})`,
            ...
            {showDropdown && searchResults.length > 0 && (
              <div style={{
                position: "absolute", top: "calc(100% + 8px)", right: 0, left: 0, zIndex: 50,
                background: C.white, borderRadius: 12,
                boxShadow: "0 8px 32px rgba(0,0,0,0.12)", border: `1px solid ${C.border}`,
                overflow: "hidden",
              }}>
          ...
          <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
            {QUICK_PILLS.map((p) => (
              <button
                key={p.idx}
                onClick={() => selectPill(p.idx)}
                style={{
                  padding: "8px 20px", borderRadius: 100,
                  background: C.white, border: `1.5px solid ${C.border}`,
                  fontSize: 14, fontWeight: 600, color: C.slate, cursor: "pointer",
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <div style={{
              ...
              background: C.primaryLight, color: C.primary, fontSize: 12, fontWeight: 700,
            ...
            {SERVICES.map((svc, i) => (
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 2px 16px rgba(89,154,215,0.06)",
                  transition: "all 0.2s", position: "relative",
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = "translateY(-4px)";
                  e.currentTarget.style.boxShadow = `0 8px 32px rgba(89,154,215,0.18)`;
                  e.currentTarget.style.borderColor = C.primary;
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = "translateY(0)";
                  e.currentTarget.style.boxShadow = "0 2px 16px rgba(89,154,215,0.06)";
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div className="form-cols" style={{ display: "flex", gap: 64, alignItems: "flex-start" }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{
                display: "inline-block", padding: "4px 14px", borderRadius: 100,
                background: C.primaryLight, color: C.primary, fontSize: 12, fontWeight: 700, marginBottom: 16,
              }}>احجز الآن</div>
              <h2 style={{ fontSize: 32, fontWeight: 900, color: C.charcoal, marginBottom: 24, lineHeight: 1.4 }}>
              ...
              {/* Kareem nudge */}
              <div style={{
                background: C.primarySubtle, borderRadius: 14, padding: "16px 20px",
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              {formSubmitted ? (
                <div style={{
                  ...
                  <h3 style={{ fontSize: 22, fontWeight: 800, color: "#166534", marginBottom: 12 }}>تم استلام طلبك ✓</h3>
                  <p style={{ fontSize: 15, color: "#15803D", lineHeight: 1.8, marginBottom: 24 }}>
                    فريق الرعاية في فيزيتا هيتواصل معاك على رقم <strong>{formData.phone}</strong> خلال ٢٤ ساعة
                  </p>
                  <div style={{
                    background: C.white, borderRadius: 14, padding: 20, textAlign: "right",
                    border: `1px solid ${C.border}`,
                  }}>
                    {["فريقنا هيتصل بيك لتحديد موعد الاستشارة المجانية", "هنفهم حالتك ونرشّحلك أفضل الخيارات المناسبة", "إحنا معاك في كل خطوة لحد ما تتعافى"].map((s, i) => (
                ...
                <form
                  ...
                  style={{
                    ...
                    boxShadow: "0 8px 48px rgba(89,154,215,0.12)",
                    border: `1px solid ${C.border}`,
                  }}
                >
                  <h3 style={{ fontSize: 20, fontWeight: 800, color: C.charcoal, marginBottom: 24 }}>
                  ...
                  <div className="form-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
                    <div>
                      <label style={{ fontSize: 13, fontWeight: 700, color: C.charcoal, display: "block", marginBottom: 6 }}>
                        الاسم بالكامل <span style={{ color: C.accent }}>*</span>
                      </label>
                      <input
                        required
                        type="text"
                    ...
                    <div>
                      <label style={{ fontSize: 13, fontWeight: 700, color: C.charcoal, display: "block", marginBottom: 6 }}>
                        رقم الموبايل <span style={{ color: C.accent }}>*</span>
                      </label>
                      <input
                        required
                        type="tel"
                        ...
                        style={{
                          width: "100%", padding: "12px 16px", borderRadius: 10,
                          border: `1.5px solid ${C.border}`, fontSize: 15, fontFamily: font,
                          direction: "ltr", background: C.white, color: C.charcoal,
                        }}
                      />
                    </div>
                  </div>
                  <div style={{ marginBottom: 16 }}>
                    <label style={{ fontSize: 13, fontWeight: 700, color: C.charcoal, display: "block", marginBottom: 6 }}>
                      التخصص المطلوب <span style={{ color: C.accent }}>*</span>
                    </label>
                    <select
                      required
                      ...
                      style={{
                        width: "100%", padding: "12px 16px", borderRadius: 10,
                        border: `1.5px solid ${C.border}`, fontSize: 15, fontFamily: font,
                        direction: "rtl", background: C.white, color: formData.specialty ? C.charcoal : C.gray,
                        cursor: "pointer",
                      }}
                    >
                  ...
                  <div style={{ marginBottom: 24 }}>
                    <label style={{ fontSize: 13, fontWeight: 700, color: C.charcoal, display: "block", marginBottom: 6 }}>
                      وصف مختصر لحالتك <span style={{ color: C.gray }}>(اختياري)</span>
                    </label>
                    <textarea
                      placeholder="اكتب أي تفاصيل تساعدنا نفهم حالتك أحسن..."
                  ...
                  <button
                    type="submit"
                    disabled={formLoading || !formData.name || !formData.phone || !formData.specialty}
                    style={{
                      ...btnPrimary,
                      width: "100%", borderRadius: 12, padding: "16px",
                      fontSize: 16, opacity: (!formData.name || !formData.phone || !formData.specialty) ? 0.5 : 1,
                      cursor: (!formData.name || !formData.phone || !formData.specialty) ? "not-allowed" : "pointer",
                    }}
                  >
                    {formLoading ? "جاري الإرسال..." : "احجز استشارتك المجانية"}
                  </button>
            ...
            {FAQS.map((faq, i) => (
              <div
                ...
                style={{
                  ...
                  border: `1.5px solid ${faqOpen === i ? C.primary : C.border}`,
                  overflow: "hidden", transition: "border-color 0.2s",
                  boxShadow: faqOpen === i ? `0 4px 20px rgba(89,154,215,0.12)` : "none",
                }}
              >
                <button
                ...
                {faqOpen === i && (
                  <div style={{ padding: "0 24px 20px", fontSize: 15, color: C.slate, lineHeight: 1.9 }}>
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      <footer style={{ background: C.charcoal, padding: "48px 24px 32px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", textAlign: "center" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 12 }}>
            <div style={{
              width: 36, height: 36, borderRadius: 8, background: "#0066CC",
          ...
          <p style={{ color: C.gray, fontSize: 13, marginBottom: 20 }}>
            © ٢٠٢٦ فيزيتا. جميع الحقوق محفوظة.
          </p>
          <p style={{ color: "#64748b", fontSize: 12 }}>
            فيزيتا لا تقدم نصائح طبية. الاستشارة النهائية مع الطبيب المعالج.
          </p>
        </div>
      </footer>
      ...
      {!chatOpen && (
        <button
          ...
          style={{
            ...
            boxShadow: `0 6px 24px rgba(89,154,215,0.45)`,
      ...
      {chatOpen && (
        <div dir="rtl" style={{
          ...
          maxHeight: "80vh", borderRadius: 20,
          ...
          {/* Disclaimer */}
          <div style={{
            background: C.primaryLight, padding: "10px 16px",
            fontSize: 12, color: C.primaryDark, textAlign: "center",
          ...
          <div style={{
              ...
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  borderRadius: m.role === "user"
                    ? "16px 16px 16px 4px"
                    : "16px 16px 4px 16px",
                  background: m.role === "user" ? C.surface : C.primary,
                  color: m.role === "user" ? C.charcoal : "#fff",
            ...
            {chatLoading && (
              <div style={{ display: "flex", justifyContent: "flex-end" }}>
                <div style={{
                  padding: "14px 18px", borderRadius: "16px 16px 4px 16px",
                  background: C.primary, display: "flex", gap: 4, alignItems: "center",
                }}>
                  {[0, 1, 2].map((d) => (
                    <span key={d} style={{
                      width: 7, height: 7, borderRadius: "50%", background: "rgba(255,255,255,0.8)",
                      display: "inline-block",
                      animation: `typing 1.2s ${d * 0.2}s ease-in-out infinite`,
                    }} />
                  ))}
                </div>
              </div>
          ...
          <div style={{
            ...
            <input
              ...
              style={{
                ...
                fontFamily: font, direction: "rtl", background: C.surface,
              }}
            />
            <button
              onClick={sendChat}
